                ...
                <label class="block">
                    ...
                    >
                        <option
                            ...
                            :value="categ.id"
                            :selected="categ.title == cat.category"
                        >{{ categ.title }}</option>
                    </select>
                </label>
                <label class="block">
...
export default {
    ...
    methods: {
        ...
        createCat() {
            ...
            delete this.cat.category
            axios.put('http://109.254.85.64/newsletter/api/db/interests/' + this.id, this.cat).then((resp) => {
                console.log(resp)
            }).catch((e) => {
    ...
    async mounted() {
        this.cat = (await axios.get('http://109.254.85.64/newsletter/api/db/interests/' + this.id)).data
